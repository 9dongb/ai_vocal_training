...
function ScaleAnalyze() {
  const notes = [
    ...
    { name: 'F3', frequency: 174.61, info: '1옥타브 파', min: 164.81, max: 185.00, nk: 'F' },
    { name: 'F_3', frequency: 185.00, info: '1옥타브 파#', min: 174.61, max: 196.00, nk: 'F_' },
    { name: 'G3', frequency: 196.00, info: '1옥타브 솔', min: 185.00, max: 207.65, nk: 'G' },
    { name: 'G_3', frequency: 207.65, info: '1옥타브 솔#', min: 196.00, max: 220.00, nk: 'G_' },
    { name: 'A3', frequency: 220.00, info: '1옥타브 라', min: 207.65, max: 233.08, nk: 'A' },
    { name: 'A_3', frequency: 233.08, info: '1옥타브 라#', min: 220.00, max: 246.94, nk: 'A_' },
      ...
      <div className="container">
        <div className="main">
          ...
          <div className="piano_set">
            <div className="piano_octave_arrow" onClick={downOctaveList}><img src="./img/arrowL.png"/></div>
          <div className="piano">
            {/* 흰 건반 */}
            {octaveNotes
          ...
          <div className="piano_octave_arrow" onClick={upOctaveList}><img src="./img/arrowR.png"/></div>
          </div>
